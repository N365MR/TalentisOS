...
| Canonical data and relationships | Implementation contract: Canonical data dictionary and relationships | 01–05, 09–13 | Schema v3 adds one canonical IndexedDB `tasks` store, task IDs, typed links, archive/restore and atomic incoming-task-reference repair. | Verified for Phase 02; future record stores must join repair transactions when enabled. |
| Daily loop: EOD, Huddle, Today/Home | Required PWA capabilities 1–6; Acceptance scenarios | 02–04 | Today and Tasks offer canonical Quick Capture and task views; EOD/Huddle and daily-loop orchestration do not exist. | Partially verified for Phase 02; validate daily loop in Phases 03–04. |
| Core guidance: Start Here, First 7 Days, roadmap, conversations, weekly review | New Leader Core; Required PWA capabilities 7 and 11 | 06–08 | Phase 06 adds local Start Here, First 7 Days and current Days 1–30 guidance with no task copies, profile or advanced controls. | Verified for Phase 06 through automated and Safari evidence; Conversations and Weekly Review remain Phase 07. |
...
| Acceptance and release evidence | Acceptance scenarios; Delivery and quality gate; release readiness gates | Every phase, especially 08 | Fourteen Node tests, source checks, production build, responsive task checks and local interaction checks pass for Phase 02. | Verified for Phase 02; broader release evidence remains Phase 08. |
